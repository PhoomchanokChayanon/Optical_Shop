...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Gochi+Hand&family=Just+Another+Hand&display=swap" rel="stylesheet">
...
<div style="height: 70px;"></div>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse " id="navbarTogglerDemo02">
                    ...
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-1">
                        ...
                        <li>
                            <a class="nav-link" onclick="user_pro()"
                                style="margin-top:-6px" id="pointer"><strong><?php echo $_SESSION['username']; ?></strong></a>
                        </li>
                        <li>
                    ...
                    <ul class="navbar-nav ms-7 mb-3 mb-lg-3">
                        <li class="nav-item">
                            ...
                            <div id="total_quantity" class="total_quantity animate__heartBeat" style="margin-top:28px; margin-left:30px; "></div>
                            <a class="nav-link" href="../cart.php" style="margin-top:-45px; "><img src="../image/cart.png" style="width: 26px; height: 25px"></a>
                            <?php else: ?>
                                <a class="nav-link" href="../cart.php" style="margin-top:5px; "><img src="../image/cart.png" style="width: 26px; height: 25px"></a>
    ...
    <form action="register_db.php" method="post">
        ...
        <div class="input-group">
            ...
            <input type="text" name="fname" pattern="{1,15}">
        </div>
        <div class="input-group">
            <label for="lname">Lastname</label>
            <input type="text" name="lname" pattern="{1,15}">
        </div>
        <div class="input-group">
        ...
        <div class="input-group">
            ...
            <input type="int" name="phone" pattern="{,10}">
        ...
        <div class="input-group">
            <button type="submit" name="reg_user" class="btn btn-outline-dark">Register</button>
        </div>
